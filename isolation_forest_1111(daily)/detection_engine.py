...
class Surpriver:
	...
	def calculate_shape(self):
		########### Change column_names here!!! but still prefer to use names from feature function, rather than hardcoding(possible to get wrong order of features).
		column_names = ['daily_return1', 'daily_return2', 'daily_return3', 'daily_return4', 'daily_return5', 'daily_return6', 'daily_return7', 
                  'eom-10-slope', 'eom-10-r-value', 'eom-10-p-value', 'eom-20-slope', 'eom-20-r-value', 'eom-20-p-value', 'eom-5-slope', 'eom-5-r-value', 'eom-5-p-value', 
                  'volume_returns1', 'volume_returns2', 'volume_returns3', 'volume_returns4', 'volume_returns5', 'volume_returns6', 'volume_returns7', 'volume_returns-slope', 'volume_returns-r-value', 'volume_returns-p-value']
...
supriver = Surpriver(START='2024-08-11',END = '2024-09-30')
